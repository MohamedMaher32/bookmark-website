...
function add() {
    let result = list.find((x) => {
        return x.name.toLowerCase() == urlName.value.toLowerCase() || x.url.toLowerCase() == urlLink.value.toLowerCase()
    })
